...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--repeat_times', type=int, default=1, help="Number of generation rounds for each text description")
        ...
        self.parser.add_argument('--eval_log', default = '/home/ltdoanh/jupyter/jupyter/ldtan/NExT-GPT/log_eval', type=str, help = "save the log file")
