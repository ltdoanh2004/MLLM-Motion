...
class Text2MotionDataset(data.Dataset):
    ...
    def __init__(self, opt, mean, std, split_file, times=1, w_vectorizer=None, eval_mode=False):
        ...
        if opt.is_train:
            ...
            # np.save('/home/ltdoanh/jupyter/jupyter/ldtan/MotionDiffuse/t2m/t2m_new_ver4/meta/mean.npy', mean)
            # np.save('/home/ltdoanh/jupyter/jupyter/ldtan/MotionDiffuse/t2m/t2m_new_ver4/meta/std.npy', std)
