...
def get_dataset_motion_loader(opt_path, batch_size, device):
    ...
    if opt.dataset_name == 't2m' or opt.dataset_name == 'kit':
        ...
        path = '/home/ltdoanh/jupyter/jupyter/ldtan/text-to-motion/glove'
...
def get_motion_loader(opt, batch_size, trainer, ground_truth_dataset, mm_num_samples, mm_num_repeats):
    ...
    if opt.dataset_name == 't2m' or opt.dataset_name == 'kit':
        w_vectorizer = WordVectorizer('/home/ltdoanh/jupyter/jupyter/ldtan/text-to-motion/glove', 'our_vab')
    else:
        raise KeyError('Dataset not recognized!!')
...
def build_models(opt):
    ...
    checkpoint = torch.load(pjoin('/home/ltdoanh/jupyter/jupyter/ldtan/MotionDiffuse', opt.dataset_name, 'text_mot_match', 'model', 'finest.tar'),
