...
from models.transformer_copy import MotionTransformer
...
from models.gaussian_diffusion_copy import (
    GaussianDiffusion,
...
class DDPMTrainer(object):
    ...
    def generate(self, caption, m_lens, dim_pose, batch_size=1024, device='cuda:0'):
        ...
        output = self.generate_batch(caption, m_lens, dim_pose, device)
        B = output.shape[0]
