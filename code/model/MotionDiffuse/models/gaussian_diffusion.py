...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        self, model, x, t,text_promts_embed,text_promts_out, clip_denoised=True, denoised_fn=None, model_kwargs=None
    ):
        """
        ...
        B, C = x.shape[:2]
        assert t.shape == (B,)
        model_output = model(x, self._scale_timesteps(t),text_promts_embed = text_promts_embed, text_promts_out = text_promts_out, **model_kwargs)
    ...
    def training_losses(self, model, x_start, t,text_promts_embed,text_promts_out, model_kwargs=None, noise=None):
        """
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            model_output = model(x_t, self._scale_timesteps(t), **model_kwargs,text_promts_embed=text_promts_embed,text_promts_out=text_promts_out )
