...
if __name__ == '__main__':
    ...
    delta_ckpt = torch.load('/home/ltdoanh/jupyter/jupyter/ldtan/NExT-GPT/ckpt/test4/pytorch_model.pt', map_location=torch.device('cuda'))
    # print(delta_ckpt)
    model.load_state_dict(delta_ckpt, strict=False)
    ...
    prompt = 'give me an image that have a person jumping'
        ...
        if isinstance(i, str):
            ...
            for m in i['img']:
                if isinstance(m, str):
                    ...
                    m[0].save(f'/home/ltdoanh/jupyter/jupyter/ldtan/NExT-GPT/code/temp/{prompt}.jpg')
            ...
            for idx, m in enumerate(i['vid']):
                if isinstance(m, str):
                    ...
                    video_path = export_to_video(video_frames=m, output_video_path=f'/home/ltdoanh/jupyter/jupyter/ldtan/NExT-GPT/code/temp/{prompt}.mp4')
            ...
            for idx, m in enumerate(i['aud']):
                if isinstance(m, str):
                    ...
                    audio_path = f'/home/ltdoanh/jupyter/jupyter/ldtan/NExT-GPT/code/temp/{prompt}.wav'
