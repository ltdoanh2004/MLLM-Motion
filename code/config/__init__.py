...
def load_model_config(stage, mode):
    ...
    config_path = f'/home/ltdoanh/jupyter/jupyter/ldtan/NExT-GPT/code/config/stage_{stage}.yaml'
...
def load_base_config():
    config_path = f'/home/ltdoanh/jupyter/jupyter/ldtan/NExT-GPT/code/config/base.yaml'
    with open(config_path) as f:
        configuration = yaml.load(f, Loader=yaml.FullLoader)
